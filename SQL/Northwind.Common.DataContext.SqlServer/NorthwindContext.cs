...
public partial class NorthwindContext : DbContext
{
    ...
    protected override void OnConfiguring(DbContextOptionsBuilder options)
    {
        ...
        {
            options.UseSqlServer("Data Source=DDC-CO-JGONZALE;Initial Catalog=Northwind;Persist Security Info=True;User ID=sa;Password=admin2023;TrustServerCertificate=True;");
        }
        options.AddInterceptors(setLastRefreshedInterceptor);
    }
